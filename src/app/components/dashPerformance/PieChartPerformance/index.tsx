...
export default function PieChartComponent() {
    ...
    return (
        <motion.div initial={{ opacity: 0, }}
            animate={{ opacity: 100 }}
            transition={{ duration: 0.3 }} className="w-full hover:cursor-default rounded-2xl border shadow-md h-full">
            ...
            {isPending ? (
                ...
                (
                    <div className="flex flex-col items-center justify-center p-9 w-full h-full">
                        ...
                        <p className="pt-5 text-black font-medium">Aproveitamento produto</p>
                    </div>
                )
            }
